...
static char* checkSumC_dv_23459607e0c2696142bb39cdddf1b92a;
...
static void* mallocInstancePointer (void *this_, int R_proc1)
{
  ...
  //  fprintf(debugFile,"dbgcmb - entering mallocInstancePointer function for component dv R_proc1 = %i \n",R_proc1);
  //  fclose(debugFile);
...
DllExport int dv_GET_NUM_NAMED_INPUTS(void *this_)
{
...
DllExport int dv_GET_NUM_NAMED_OUTPUTS(void *this_)
{
    //This comes from CmodelCompiler.createCtlExtraIOCode
    //int cntl_idx;
    //rpcControlStructurePointer = this_;
...
DllExport int dv_ADD_EXTRA_IO(void *this_, int R_proc1)
{
    //This comes from CmodelCompiler.createCtlExtraIOCode
    int cntl_idx;
    rpcControlStructurePointer = this_;
...
DllExport int dv_GET_FLAG_PARTICIPATION(void *this_)
{
...
DllExport void dv_DM_RW (void *this_, int R_proc1,  int *wdadr_ptr1)
{
    rpcControlStructurePointer = this_;
...
//setting the total size of the memory map to 480
   freeScratchMemoryPointers();
}
DllExport void dv_RR(void *this_, int R_proc1)
{
    rpcControlStructurePointer = this_;
    int __idata = 0;
    int __inDMCode = 0;
...
DllExport int dv_getDMSize(void *this_, int R_proc1)
{
    return((480)/4);
}
DllExport void dv_INIT(void *this_)
{
    rpcControlStructurePointer = this_;
    ramPassNumber = 0;
    initializeParameterDataRW(this_);
...
DllExport unsigned int dv_getVariableDMOffset(char* variableName)
{
    int returnValue;
