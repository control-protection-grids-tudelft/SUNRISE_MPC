...
Follow the procedure:
  1. Open the IEPG_AdvancedControl13.rtfx model in RS-CAD.
  ...
  4. In IEPG_AdvancedControl14.rtfx, an artificial neural network (ANN) component with appropriate weight factors and biases is added. In this model, the NN is integrated to support the existing deadbeat control for AC currents.
